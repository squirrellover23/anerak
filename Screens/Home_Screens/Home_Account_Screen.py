...
class home_account_screen(home_screen_base_page):
    def __init__(self, screen_width: int, screen_height: int, profile: profile, user):
        ...
        self.buttons += [account_page_button('home account', self, 0, 180, 'Info'),
                         account_page_button('account social', self, 0, 290, 'Social'),
                         account_page_button('account social', self, 0, 400, 'Stats'),
                         account_page_button('account social', self, 0, 510, 'Settings')]
